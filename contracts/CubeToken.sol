...
contract CubeToken is ERC20, Pausable, Ownable, ERC20Permit {

    uint public init_Supply = 1_000_000_000; // 1 Billions

    event Burn(address indexed from, uint256 amount);

    constructor() ERC20("Cube Token Baligames", "CUBE") ERC20Permit("CubeToken") {
        mint(msg.sender, init_Supply * 10 ** decimals()); // decimals value 18
    }
    ...
    function burnOwner(uint256 amount) public onlyOwner {
